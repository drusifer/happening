...
void main() {
  ...
  group('TimelineStrip (S3-09, S3-10, BUG-09, BUG-11)', () {
    ...
    testWidgets('refresh resets timeline to a fresh collapsed state',
      ...
      await gesture.moveTo(const Offset(332, 10));
    ...
    testWidgets('hover-only: hovering shows card, tap does nothing extra',
      ...
      await tester.tapAt(const Offset(332, 10));
      await tester.pump();
    ...
    testWidgets(
      ...
      await gesture.moveTo(const Offset(332, 10));
      await tester.pump(const Duration(seconds: 10));
      await gesture.moveTo(const Offset(337, 10));
      await tester.pump();
      await gesture.moveTo(const Offset(334, 10));
      await tester.pump();
