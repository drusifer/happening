...
11. **Single Source of Truth for Tasks (CRITICAL)**: Mouse must write sprint tasks directly to the root [task.md](task.md). Do not duplicate or maintain secondary sprint task lists inside agent folders.
